...
const STEPS = [
  {
    title: 'Escríbenos',
    text: 'Pulsa el botón y se abrirá WhatsApp con nuestro número ya puesto.',
  },
  {
  ...
  },
  {
    ...
    text: 'Te respondemos en cuanto podamos para confirmar la reserva.',
  },
]
    ...
    <section id="reservas" className="reservas">
      <div className="reservas__inner">
        <div className="reservas__copy">
          ...
          <h2>Resérvanos por WhatsApp, sin líos</h2>
          <p className="reservas__lead">
            Nada de formularios largos. Nos escribes, nos dices cuántos sois y a qué hora
